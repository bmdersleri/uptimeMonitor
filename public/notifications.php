...
<div class="shell">
    ...
    <section class="panel">
        <div class="panel-head">
            ...
            <div class="muted">Ayarlar .env dosyasina kaydedilir.</div>
        </div>
        <form method="post">
            ...
            <div class="settings-grid">
                ...
                <div class="field">
                    <div class="switch-row">
                        ...
                        <label for="notify_email_enabled" style="margin:0;color:var(--text);">Email bildirimi aktif</label>
                    </div>
                ...
                <div class="field">
                    <div class="switch-row">
                        ...
                        <label for="notify_telegram_enabled" style="margin:0;color:var(--text);">Telegram bildirimi aktif</label>
                    </div>
